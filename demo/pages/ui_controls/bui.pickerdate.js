loader.define(function(require, exports, module) {
    ...
    var uiPickerdate = bui.pickerdate({
        ...
        //     let mindate = "2023/4/4 15:00";
        //     let val = bui.date.convert(value).getTime();
        //     let minval = bui.date.convert(mindate).getTime();

        //     if( val <= minval ){
        //         bui.hint(`日期不能小于${mindate}`)
        //     }
        // },
        autoClose: true,
        callback: function(e) {
    ...
    $("#show7").click(function(argument) {
        ...
        let maxdate = bui.date.after(new Date(), 100);
        // 设置最大值, 并重置列数
        // uiPickerdate.max("2024/9/30");
        uiPickerdate.max(maxdate);
        uiPickerdate.cols();
    ...
    var uiPickerdateWeek = bui.pickerdate({
        ...
        onChange: function(value) {
            ...
            let ndate = `<div class="bui-box-center">${value} ${weeks[index]}</div>`;
            this.modifyTitle(ndate)
            // 修改列
            // this.cols({
            //     hour: "none",
            //     minute: "none",
