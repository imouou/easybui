loader.define(function(require, exports, module, global) {
    var siteDir = global.siteDir;

    // get
    var uiAjax = bui.get(siteDir + "userlist.json")

    // post
    var uiAjax2 = bui.post(siteDir + "versionUpdate.json", {
        type: "new"
    });
    ...
    var uiAjax3 = uiAjax.then(function(res) {
        return bui.get(siteDir + "versionUpdate.json", {
            data: res.data[0]
        });
    })
    ...
    $("#put").click(function() {
        var uiAjaxPut = bui.put(siteDir + "userlist.json", {
            type: "new"
        }).then(function(res) {
            console.log(res)
        }, function(res) {
    ...
    $("#delete").click(function() {
        var uiAjaxPut = bui.delete(siteDir + "userlist.json", {
            type: "delete"
        }).then(function(res) {
            console.log(res)
        }, function(res) {
